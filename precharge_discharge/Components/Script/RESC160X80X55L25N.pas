...
Procedure CreateComponentRESC160X80X55L25N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('RESC160X80X55L25N');
        NewPcbLibComp.Name := 'RESC160X80X55L25N';
        NewPCBLibComp.Description := 'Resistor, Chip; 1.60 mm L X 0.80 mm W X 0.55 mm H Body';
        NewPCBLibComp.Height := MMsToCoord(0.55);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.812, 0, 0, 0, eRoundedRectangular, 0.746, 0.97, 180, 49.87, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.812, 0, 0, 0, eRoundedRectangular, 0.746, 0.97, 0, 49.87, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.55, 0.4, -0.55, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.55, -0.4, -0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, -0.4, -0.8, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, 0.4, -0.55, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.55, -0.4, 0.55, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.55, 0.4, 0.8, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, 0.55, -0.4, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, -0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.875, -0.475, -0.875, 0.475, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.875, 0.475, 0.875, 0.475, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.875, 0.475, 0.875, -0.475, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.875, -0.475, -0.875, -0.475, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.319, 0.475, 0.319, 0.475, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.319, -0.475, 0.319, -0.475, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.385, -0.675, -1.385, 0.675, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.385, 0.675, 1.385, 0.675, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.385, 0.675, 1.385, -0.675, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.385, -0.675, -1.385, -0.675, eMechanical7, 0.05, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 0.25, 0, 360, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0.338, 0, -0.338, 0, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0, 0.338, 0, -0.338, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\ivans\Desktop\FESB Racing\Altium\Hardware\Components\Script\RESC160X80X55L25.STEP', false);
...
Begin
    ...
    CreateComponentRESC160X80X55L25N(0);
