...
Procedure CreateComponentTO254P1065X485X2200_3(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('TO254P1065X485X2200-3');
        NewPcbLibComp.Name := 'TO254P1065X485X2200-3';
        NewPCBLibComp.Description := 'Flange Mount (TO) Vertical, 2.54 mm pitch; 3 pin, 10.65 mm W X 4.85 mm H X 22.00 mm mounted height';
        NewPCBLibComp.Height := MMsToCoord(22);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.2, 0, eBottomLayer, 0, 0, 0, 0, eRectangular, 1.8, 1.8, eRounded, 1.8, 1.8, eRectangular, 1.8, 1.8, 90, 0, -1.8, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.2, 0, eBottomLayer, 2.54, 0, 0, 0, eRounded, 1.8, 1.8, eRounded, 1.8, 1.8, eRounded, 1.8, 1.8, 0, 0, -1.8, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 1.2, 0, eBottomLayer, 5.08, 0, 0, 0, eRounded, 1.8, 1.8, eRounded, 1.8, 1.8, eRounded, 1.8, 1.8, 0, 0, -1.8, 0, True);

        CreateComponentTrack(NewPCBLibComp, 0.425, -0.315, -0.425, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.425, -0.315, -0.425, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.425, 0.315, 0.425, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.425, 0.315, 0.425, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.965, -0.315, 2.115, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.115, -0.315, 2.115, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.115, 0.315, 2.965, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.965, 0.315, 2.965, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.505, -0.315, 4.655, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.655, -0.315, 4.655, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.655, 0.315, 5.505, 0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.505, 0.315, 5.505, -0.315, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, -2.28, -2.785, 2.57, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, 2.57, 7.865, 2.57, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, 2.57, 7.865, -2.28, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, -2.28, -2.785, -2.28, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, -2.28, -2.785, 2.57, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, 2.57, 7.865, 2.57, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, 2.57, 7.865, -2.28, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, -2.28, -2.785, -2.28, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, -2.28, -2.785, 2.57, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.785, 2.57, 7.865, 2.57, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, 2.57, 7.865, -2.28, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.865, -2.28, -2.785, -2.28, eTopOverlay, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 8.115, -2.53, 8.115, 2.82, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 8.115, 2.82, -3.035, 2.82, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -3.035, 2.82, -3.035, -2.53, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -3.035, -2.53, 8.115, -2.53, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\TO254P1065X485X2200-3.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('TO254P1065X485X2200-3');
...
Begin
    ...
    CreateComponentTO254P1065X485X2200_3(0);
