...
Procedure CreateComponentCAPC320X250X210L60N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPC320X250X210L60N');
        NewPcbLibComp.Name := 'CAPC320X250X210L60N';
        NewPCBLibComp.Description := 'Capacitor, Non-polarized, Chip; 3.20 mm L X 2.50 mm W X 2.10 mm H Body';
        NewPCBLibComp.Height := MMsToCoord(2.1);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -1.421, 0, 0, 0, eRoundedRectangular, 1.368, 2.715, 180, 36.55, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 1.421, 0, 0, 0, eRoundedRectangular, 1.368, 2.715, 0, 36.55, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1, 1.25, -1, -1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -1.25, -1.6, -1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, -1.25, -1.6, 1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, 1.25, -1, 1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -1.25, 1, 1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 1.25, 1.6, 1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, 1.25, 1.6, -1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -1.25, 1, -1.25, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.6, 1.25, 1.6, -1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -1.25, -1.6, -1.25, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.75, -1.35, -1.75, 1.35, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.75, 1.35, 1.75, 1.35, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.75, 1.35, 1.75, -1.35, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.75, -1.35, -1.75, -1.35, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.617, 1.35, 0.617, 1.35, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.617, -1.35, 0.617, -1.35, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.305, -1.55, -2.305, 1.55, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.305, 1.55, 2.305, 1.55, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.305, 1.55, 2.305, -1.55, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.305, -1.55, -2.305, -1.55, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\ivans\Desktop\FESB Racing\Altium\Hardware\Components\Script\CAPC320X250X210L60.STEP', false);
...
Begin
    ...
    CreateComponentCAPC320X250X210L60N(0);
