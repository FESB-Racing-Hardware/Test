...
Procedure CreateComponentRESRR6700W750L9150T2000H2000(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('RESRR6700W750L9150T2000H2000');
        NewPcbLibComp.Name := 'RESRR6700W750L9150T2000H2000';
        NewPCBLibComp.Description := 'Resistor, Radial (Molded); 67.00 mm pitch X 7.50 mm W X 91.50 mm L X 20.00 mm T X 20.00 mm H body';
        NewPCBLibComp.Height := MMsToCoord(20);
        ...
        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 8.2, 0, eBottomLayer, -33.5, 0, 0, 0, eRounded, 12.3, 12.3, eRounded, 12.3, 12.3, eRounded, 12.3, 12.3, 0, 0, -12.3, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 8.2, 0, eBottomLayer, 33.5, 0, 0, 0, eRounded, 12.3, 12.3, eRounded, 12.3, 12.3, eRounded, 12.3, 12.3, 0, 0, -12.3, 0, True);

        CreateComponentArc(NewPCBLibComp, -33.5, 0, 4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 33.5, 0, 4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, -10, -45.75, 10, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, 10, 45.75, 10, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, 10, 45.75, -10, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, -10, -45.75, -10, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, -10, -45.75, 10, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, 10, 45.75, 10, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, 10, 45.75, -10, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, -10, -45.75, -10, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, -10, -45.75, 10, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -45.75, 10, 45.75, 10, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, 10, 45.75, -10, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 45.75, -10, -45.75, -10, eTopOverlay, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -46, -10.25, 46, -10.25, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 46, -10.25, 46, 10.25, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 46, 10.25, -46, 10.25, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -46, 10.25, -46, -10.25, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('D:\Fakultet\FESB Team Racing\Električna formula 1\Scripts\RESRR6700W750L9150T2000H2000.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('RESRR6700W750L9150T2000H2000');
...
Begin
    ...
    CreateComponentRESRR6700W750L9150T2000H2000(0);
