...
Procedure CreateComponentSOD375X160X135L40X60N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('SOD375X160X135L40X60N');
        NewPcbLibComp.Name := 'SOD375X160X135L40X60N';
        NewPCBLibComp.Description := 'Diode, Small Outline Diode (SOD); 2.65 mm L X 1.60 mm W X 1.35 mm H body';
        NewPCBLibComp.Height := MMsToCoord(1.35);

        CreateSMDComponentPad(NewPCBLibComp, 'C', eTopLayer, -1.78, 0, 0, 0, eRoundedRectangular, 0.76, 0.829, 180, 50, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, 'A', eTopLayer, 1.78, 0, 0, 0, eRoundedRectangular, 0.76, 0.829, 0, 50, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1.475, 0.3, -1.475, -0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.475, -0.3, -1.875, -0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.875, -0.3, -1.875, 0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.875, 0.3, -1.475, 0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.475, -0.3, 1.475, 0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.475, 0.3, 1.875, 0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.875, 0.3, 1.875, -0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.875, -0.3, 1.475, -0.3, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.325, -0.8, -1.325, 0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.325, 0.8, 1.325, 0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.325, 0.8, 1.325, -0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.325, -0.8, -1.325, -0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.4, -0.9, -1.4, 0.9, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.4, 0.9, 1.4, 0.9, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, 0.9, 1.4, -0.9, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, -0.9, -1.4, -0.9, eMechanical3, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.4, 0.594, 1.4, 0.9, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, 0.9, -1.4, 0.9, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.4, 0.9, -1.4, 0.594, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, -0.594, 1.4, -0.9, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, -0.9, -1.4, -0.9, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.4, -0.9, -1.4, -0.594, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, -1.1, 1.6, -1.1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -1.1, 1.6, -0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -0.614, 2.36, -0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.36, -0.614, 2.36, 0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.36, 0.614, 1.6, 0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, 0.614, 1.6, 1.1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, 1.1, -1.6, 1.1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, 1.1, -1.6, 0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, 0.614, -2.36, 0.614, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.36, 0.614, -2.36, -0.614, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\SOD375X160X135L40X60.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('SOD375X160X135L40X60');
...
Begin
    ...
    CreateComponentSOD375X160X135L40X60N(0);
