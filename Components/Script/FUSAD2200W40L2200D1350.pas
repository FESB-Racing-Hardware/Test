...
Procedure CreateComponentFUSAD2200W40L2200D1350(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('FUSAD2200W40L2200D1350');
        NewPcbLibComp.Name := 'FUSAD2200W40L2200D1350';
        NewPCBLibComp.Description := 'Fuse, Axial; 22.00 mm Pitch X 0.40 mm W 22.00 mm L X 13.50 mm Dia. body';
        NewPCBLibComp.Height := MMsToCoord(13.5);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.5, 0, eBottomLayer, -11, 0, 0, 0, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, 0, 0, -1.5, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.5, 0, eBottomLayer, 11, 0, 0, 0, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, 0, 0, -1.5, 0, True);

        CreateComponentArc(NewPCBLibComp, -11, 0, 0.2, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 11, 0, 0.2, 0, 360, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11, -4.5, -11, 4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11, 4.5, 11, 4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 11, 4.5, 11, -4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 11, -4.5, -11, -4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11, -4.5, -11, 4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -11, 4.5, 11, 4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 11, 4.5, 11, -4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 11, -4.5, -11, -4.5, eMechanical3, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 11, -0.975, 11, -4.5, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 11, -4.5, -11, -4.5, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -11, -4.5, -11, -0.975, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -11, 0.975, -11, 4.5, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -11, 4.5, 11, 4.5, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 11, 4.5, 11, 0.975, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -11.25, -4.75, 11.25, -4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 11.25, -4.75, 11.25, -1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 11.25, -1, 12, -1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 12, -1, 12, 1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 12, 1, 11.25, 1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 11.25, 1, 11.25, 4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 11.25, 4.75, -11.25, 4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -11.25, 4.75, -11.25, 1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -11.25, 1, -12, 1, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -12, 1, -12, -1, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\FUSAD2200W40L2200D1350.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('FUSAD2200W40L2200D1350');
...
Begin
    ...
    CreateComponentFUSAD2200W40L2200D1350(0);
