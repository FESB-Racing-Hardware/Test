...
Procedure CreateComponentCAPPRD250W80D600H1100(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPPRD250W80D600H1100');
        NewPcbLibComp.Name := 'CAPPRD250W80D600H1100';
        NewPCBLibComp.Description := 'Capacitor, Polarized, Radial (Electrolytic); 2.50 mm Pitch X 6.00 mm Dia X 11.00 mm H body';
        NewPCBLibComp.Height := MMsToCoord(11);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1, 0, eBottomLayer, -1.25, 0, 0, 0, eRectangular, 1.5, 1.5, eRounded, 1.5, 1.5, eRectangular, 1.5, 1.5, 180, 0, -1.5, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1, 0, eBottomLayer, 1.25, 0, 0, 0, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, 0, 0, -1.5, 0, True);

        CreateComponentArc(NewPCBLibComp, -1.25, 0, 0.4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 1.25, 0, 0.4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 3, 0, 360, eMechanical7, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 3, 0, 360, eMechanical3, 0.12, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 3, 0, 360, eTopOverlay, 0.15, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 3.325, 0, 360, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\CAPPRD250W80D600H1100.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('CAPPRD250W80D600H1100');
...
Begin
    ...
    CreateComponentCAPPRD250W80D600H1100(0);
