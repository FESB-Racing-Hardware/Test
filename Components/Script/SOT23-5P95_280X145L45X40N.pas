...
Procedure CreateComponentSOT23_5P95_280X145L45X40N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('SOT23-5P95_280X145L45X40N');
        NewPcbLibComp.Name := 'SOT23-5P95_280X145L45X40N';
        NewPCBLibComp.Description := 'Small Outline Transistor, SOT-23 Type, 0.95 mm pitch; 5 pin, 2.90 mm L X 1.60 mm W X 1.45 mm H body';
        NewPCBLibComp.Height := MMsToCoord(1.45);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.95, -1.128, 0, 0, eRoundedRectangular, 1.159, 0.609, 270, 49.92, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0, -1.128, 0, 0, eRoundedRectangular, 1.159, 0.609, 270, 49.92, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '3', eTopLayer, 0.95, -1.128, 0, 0, eRoundedRectangular, 1.159, 0.609, 270, 49.92, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '4', eTopLayer, 0.95, 1.128, 0, 0, eRoundedRectangular, 1.159, 0.609, 90, 49.92, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '5', eTopLayer, -0.95, 1.128, 0, 0, eRoundedRectangular, 1.159, 0.609, 90, 49.92, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1.15, -0.95, -0.75, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.75, -0.95, -0.75, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.75, -1.4, -1.15, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.15, -1.4, -1.15, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.2, -0.95, 0.2, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.2, -0.95, 0.2, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.2, -1.4, -0.2, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.2, -1.4, -0.2, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.75, -0.95, 1.15, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.15, -0.95, 1.15, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.15, -1.4, 0.75, -1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.75, -1.4, 0.75, -0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.15, 0.95, 0.75, 0.95, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.75, 0.95, 0.75, 1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.75, 1.4, 1.15, 1.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.15, 1.4, 1.15, 0.95, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.45, 0.8, 1.45, -0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.45, -0.8, -1.45, -0.8, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.525, -0.875, -1.525, 0.875, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.525, 0.875, 1.525, 0.875, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.525, 0.875, 1.525, -0.875, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.525, -0.875, -1.525, -0.875, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.466, 0.875, -0.466, 0.875, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.525, 0.875, 1.525, -0.875, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.525, -0.875, -1.525, 0.875, eTopOverlay, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.725, -1.075, 1.725, 1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.725, 1.075, 1.454, 1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.454, 1.075, 1.454, 1.908, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.454, 1.908, -1.454, 1.908, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.454, 1.908, -1.454, 1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.454, 1.075, -1.725, 1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.725, 1.075, -1.725, -1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.725, -1.075, -1.454, -1.075, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.454, -1.075, -1.454, -1.908, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.454, -1.908, 1.454, -1.908, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\SOT23-5P95_280X145L45X40.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('SOT23-5P95_280X145L45X40');
...
Begin
    ...
    CreateComponentSOT23_5P95_280X145L45X40N(0);
