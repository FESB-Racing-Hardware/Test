...
Procedure CreateComponentDIP1092W45P254L959H508Q8(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('DIP1092W45P254L959H508Q8');
        NewPcbLibComp.Name := 'DIP1092W45P254L959H508Q8';
        NewPCBLibComp.Description := 'DIP, 10.92 mm lead span, 2.54 mm pitch; 8 pin, 9.59 mm L X 7.94 mm W X 5.08 mm H body';
        NewPCBLibComp.Height := MMsToCoord(5.08);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 0.75, 0, eBottomLayer, -3.81, -5.46, 0, 0, eRectangular, 1.15, 1.15, eRounded, 1.15, 1.15, eRectangular, 1.15, 1.15, 270, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 0.75, 0, eBottomLayer, -1.27, -5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 0.75, 0, eBottomLayer, 1.27, -5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '4', eRoundHole, 0.75, 0, eBottomLayer, 3.81, -5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '5', eRoundHole, 0.75, 0, eBottomLayer, 3.81, 5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '6', eRoundHole, 0.75, 0, eBottomLayer, 1.27, 5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '7', eRoundHole, 0.75, 0, eBottomLayer, -1.27, 5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '8', eRoundHole, 0.75, 0, eBottomLayer, -3.81, 5.46, 0, 0, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, eRounded, 1.15, 1.15, 0, 0, -1.15, 0, True);

        CreateComponentTrack(NewPCBLibComp, -4.075, -5.335, -3.545, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -3.545, -5.335, -3.545, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -3.545, -5.585, -4.075, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4.075, -5.585, -4.075, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.535, -5.335, -1.005, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.005, -5.335, -1.005, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.005, -5.585, -1.535, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.535, -5.585, -1.535, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.005, -5.335, 1.535, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.535, -5.335, 1.535, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.535, -5.585, 1.005, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.005, -5.585, 1.005, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 3.545, -5.335, 4.075, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.075, -5.335, 4.075, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.075, -5.585, 3.545, -5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 3.545, -5.585, 3.545, -5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.075, 5.335, 3.545, 5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 3.545, 5.335, 3.545, 5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 3.545, 5.585, 4.075, 5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.075, 5.585, 4.075, 5.335, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -4.075, 5.585, -3.545, 5.585, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -3.545, 5.585, -3.545, 5.335, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, -4.13, -5.08, 4.13, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, 4.13, 5.08, 4.13, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, 4.13, 5.08, -4.13, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, -4.13, -5.08, -4.13, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, -4.13, -5.08, 4.13, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, 4.13, 5.08, 4.13, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, 4.13, 5.08, -4.13, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, -4.13, -5.08, -4.13, eMechanical3, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 4.565, -4.13, 5.08, -4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, -4.13, 5.08, 4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, 4.13, 4.565, 4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4.565, -4.13, -5.08, -4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, -4.13, -5.08, 4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, 4.13, -4.565, 4.13, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.33, -4.38, 5.33, 4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.33, 4.38, 4.635, 4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.635, 4.38, 4.635, 6.285, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.635, 6.285, -4.635, 6.285, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.635, 6.285, -4.635, 4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.635, 4.38, -5.33, 4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.33, 4.38, -5.33, -4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.33, -4.38, -4.635, -4.38, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.635, -4.38, -4.635, -6.285, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.635, -6.285, 4.635, -6.285, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\DIP1092W45P254L959H508Q8.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('DIP1092W45P254L959H508Q8');
...
Begin
    ...
    CreateComponentDIP1092W45P254L959H508Q8(0);
