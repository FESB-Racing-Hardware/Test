...
Procedure CreateComponentRESC200X125X60L35N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('RESC200X125X60L35N');
        NewPcbLibComp.Name := 'RESC200X125X60L35N';
        NewPCBLibComp.Description := 'Resistor, Chip; 2.00 mm L X 1.25 mm W X 0.60 mm H Body';
        NewPCBLibComp.Height := MMsToCoord(0.6);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.93, 0, 0, 0, eRoundedRectangular, 0.87, 1.42, 180, 49.89, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.93, 0, 0, 0, eRoundedRectangular, 0.87, 1.42, 0, 49.89, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.65, 0.625, -0.65, -0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.65, -0.625, -1, -0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -0.625, -1, 0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.625, -0.65, 0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.65, -0.625, 0.65, 0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.65, 0.625, 1, 0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, 0.65, -0.625, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, -1, -0.625, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.05, -0.7, -1.05, 0.7, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.05, 0.7, 1.05, 0.7, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.05, 0.7, 1.05, -0.7, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.05, -0.7, -1.05, -0.7, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.375, 0.7, 0.375, 0.7, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.375, -0.7, 0.375, -0.7, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.5645, -0.9, -1.5645, 0.9, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.5645, 0.9, 1.5645, 0.9, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.5645, 0.9, 1.5645, -0.9, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.5645, -0.9, -1.5645, -0.9, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\ivans\Desktop\FESB Racing\Altium\Hardware\Components\Script\RESC200X125X60L35.STEP', false);
...
Begin
    ...
    CreateComponentRESC200X125X60L35N(0);
