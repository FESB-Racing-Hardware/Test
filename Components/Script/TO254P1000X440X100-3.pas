...
Procedure CreateComponentTO254P1000X440X100_3(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('TO254P1000X440X100-3');
        NewPcbLibComp.Name := 'TO254P1000X440X100-3';
        NewPCBLibComp.Description := 'Flange Mount (TO) Vertical, 2.54 mm pitch; 3 pin, 10.00 mm W X 4.40 mm H X 1.00 mm mounted height';
        NewPCBLibComp.Height := MMsToCoord(1);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.3, 0, eBottomLayer, 0, 0, 0, 0, eRectangular, 1.96, 1.96, eRounded, 1.96, 1.96, eRectangular, 1.96, 1.96, 90, 0, -1.96, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.3, 0, eBottomLayer, 2.54, 0, 0, 0, eRounded, 1.96, 1.96, eRounded, 1.96, 1.96, eRounded, 1.96, 1.96, 0, 0, -1.96, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 1.3, 0, eBottomLayer, 5.08, 0, 0, 0, eRounded, 1.96, 1.96, eRounded, 1.96, 1.96, eRounded, 1.96, 1.96, 0, 0, -1.96, 0, True);

        CreateComponentTrack(NewPCBLibComp, 0.45, -0.35, -0.45, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.45, -0.35, -0.45, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.45, 0.35, 0.45, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.45, 0.35, 0.45, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.99, -0.35, 2.09, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.09, -0.35, 2.09, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.09, 0.35, 2.99, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.99, 0.35, 2.99, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.53, -0.35, 4.63, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.63, -0.35, 4.63, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4.63, 0.35, 5.53, 0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.53, 0.35, 5.53, -0.35, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, -2, -2.46, 2.4, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, 2.4, 7.54, 2.4, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, 2.4, 7.54, -2, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, -2, -2.46, -2, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, -2, -2.46, 2.4, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, 2.4, 7.54, 2.4, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, 2.4, 7.54, -2, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, -2, -2.46, -2, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, -2, -2.46, 2.4, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.46, 2.4, 7.54, 2.4, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, 2.4, 7.54, -2, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.54, -2, -2.46, -2, eTopOverlay, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 7.94, -2.4, 7.94, 2.8, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 7.94, 2.8, -2.86, 2.8, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.86, 2.8, -2.86, -2.4, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.86, -2.4, 7.94, -2.4, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\TO254P1000X440X100-3.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('TO254P1000X440X100-3');
...
Begin
    ...
    CreateComponentTO254P1000X440X100_3(0);
