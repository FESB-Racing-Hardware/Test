...
Procedure CreateComponentSIP900W100P500L1000H1250Q2(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('SIP900W100P500L1000H1250Q2');
        NewPcbLibComp.Name := 'SIP900W100P500L1000H1250Q2';
        NewPCBLibComp.Description := 'SIP, 5.00 mm pitch; 2 pin, 10.00 mm L X 9.00 mm W X 12.50 mm H body';
        NewPCBLibComp.Height := MMsToCoord(12.5);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.55, 0, eBottomLayer, -2.5, 0, 0, 0, eRectangular, 2.33, 2.33, eRounded, 2.33, 2.33, eRectangular, 2.33, 2.33, 270, 0, -2.33, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.55, 0, eBottomLayer, 2.5, 0, 0, 0, eRounded, 2.33, 2.33, eRounded, 2.33, 2.33, eRounded, 2.33, 2.33, 0, 0, -2.33, 0, True);
        ...
        CreateComponentTrack(NewPCBLibComp, 3, -0.5, 2, -0.5, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2, -0.5, 2, 0.5, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5, -4.5, -5, 4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5, 4.5, 5, 4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5, 4.5, 5, -4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5, -4.5, -5, -4.5, eMechanical7, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5, -4.5, -5, 4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5, 4.5, 5, 4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5, 4.5, 5, -4.5, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5, -4.5, -5, -4.5, eMechanical3, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 3.845, -4.5, 5, -4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5, -4.5, 5, 4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5, 4.5, 3.845, 4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -3.845, -4.5, -5, -4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5, -4.5, -5, 4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5, 4.5, -3.845, 4.5, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.25, -4.75, 5.25, 4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.25, 4.75, -5.25, 4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.25, 4.75, -5.25, -4.75, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.25, -4.75, 5.25, -4.75, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\SIP900W100P500L1000H1250Q2.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('SIP900W100P500L1000H1250Q2');
...
Begin
    ...
    CreateComponentSIP900W100P500L1000H1250Q2(0);
