...
Procedure CreateComponentRESC160X80X55L30N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('RESC160X80X55L30N');
        NewPcbLibComp.Name := 'RESC160X80X55L30N';
        NewPCBLibComp.Description := 'Resistor, Chip; 1.60 mm L X 0.80 mm W X 0.55 mm H Body';
        NewPCBLibComp.Height := MMsToCoord(0.55);

        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.76, 0, 0, 0, eRoundedRectangular, 0.85, 0.929, 180, 50.12, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.76, 0, 0, 0, eRoundedRectangular, 0.85, 0.929, 0, 50.12, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.5, 0.4, -0.5, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.5, -0.4, -0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, -0.4, -0.8, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, 0.4, -0.5, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, -0.4, 0.5, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, 0.4, 0.8, 0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, 0.5, -0.4, eMechanical5, 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, -0.8, -0.4, eMechanical5, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.875, -0.45, -0.875, 0.45, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.875, 0.45, 0.875, 0.45, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.875, 0.45, 0.875, -0.45, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.875, -0.45, -0.875, -0.45, eMechanical3, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.215, 0.45, 0.215, 0.45, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.215, -0.45, 0.215, -0.45, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.385, -0.65, -1.385, 0.65, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.385, 0.65, 1.385, 0.65, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.385, 0.65, 1.385, -0.65, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.385, -0.65, -1.385, -0.65, eMechanical7, 0.05, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 0.244, 0, 360, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0.325, 0, -0.325, 0, eMechanical7, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0, 0.325, 0, -0.325, eMechanical7, 0.05, False);

        STEPmodel := PcbServer.PCBObjectFactory(eComponentBodyObject, eNoDimension, eCreate_Default);
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\ivans\Desktop\FESB Racing\Altium\Hardware\Components\Script\RESC160X80X55L30.STEP', false);
...
Begin
    ...
    CreateComponentRESC160X80X55L30N(0);
