...
Procedure CreateComponentCAPPRD750W80D1800H4500(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPPRD750W80D1800H4500');
        NewPcbLibComp.Name := 'CAPPRD750W80D1800H4500';
        NewPCBLibComp.Description := 'Capacitor, Polarized, Radial (Electrolytic); 7.50 mm Pitch X 18.00 mm Dia X 45.00 mm H body';
        NewPCBLibComp.Height := MMsToCoord(45);

        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1, 0, eBottomLayer, -3.75, 0, 0, 0, eRectangular, 1.5, 1.5, eRounded, 1.5, 1.5, eRectangular, 1.5, 1.5, 180, 0, -1.5, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1, 0, eBottomLayer, 3.75, 0, 0, 0, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, eRounded, 1.5, 1.5, 0, 0, -1.5, 0, True);

        CreateComponentArc(NewPCBLibComp, -3.75, 0, 0.4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 3.75, 0, 0.4, 0, 360, eMechanical5, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 9, 0, 360, eMechanical7, 0.025, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 9, 0, 360, eMechanical3, 0.12, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 9, 0, 360, eTopOverlay, 0.12, False);
        CreateComponentArc(NewPCBLibComp, 0, 0, 9.31, 0, 360, eMechanical7, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('C:\Users\Korisnik\Desktop\FESB Racing\Components\Script\CAPPRD750W80D1800H4500.STEP', false);
        STEPModel.Layer := eMechanical1;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('CAPPRD750W80D1800H4500');
...
Begin
    ...
    CreateComponentCAPPRD750W80D1800H4500(0);
